...
<div>
<script type="math/tex">
P_D = P_{CON} + P_{SW\_OPEN} + P_{SW\_CLOSE} = 0.1148 + (0.0065 + 0.0085)  \X 10^(-3) \approx 0.1148W (2-1-5)
</script>
</div>
</center>
<br>
...
<div>
<script type="math/tex">
P_{Cu} = I_F^2 \ast DCR = 1.752  \X 0.11 \approx 0.3369W (2-1-7)
</script>
</div>
</center>
<br>
...
<div>
<script type="math/tex">
ESR \le \frac {V_{o\_RIPPLE\_MAX}}{I_o \ast r_{Ui \_ MAX}} = \frac {0.235}{2.2 \X 0.12} = 0.8902Ω （2-2-14）
</script>
</div>
</center>
<br>
