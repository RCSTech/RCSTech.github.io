...
<div style="text-align:left"><img src="{{site.img_path}}/2015-03-30-IR-Emitter-Led_1.png" style="width:600px">
</div>
<br>
<div style="text-align:right"><img src="{{site.img_path}}/2015-03-30-IR-Emitter-Led-attention.png" style="width:600px">
</div>
<br>
...
<div style="text-align:left"><img src="{{site.img_path}}/2015-03-30-reception-diode.png" style="width:600px">
</div>
<br>
<div style="text-align:right"><img src="{{site.img_path}}/2015-03-30-IR-distance_1.png" style="width:600px">
</div>
<br>
...
<div style="text-align:left"><img src="{{site.img_path}}/2015-03-30-Infrared-on-the-tube_1.png" style="width:600px">
</div>
<br>
<div style="text-align:right"><img src="{{site.img_path}}/2015-03-30-Infrared-on-the-tube‘s-datasheet.png" style="width:600px">
</div>
<br>
...
<tr>
    <th>激光对管</th>
    <th>激光发射，直线度高，外包热缩管限制通孔范围，基本发散角为0</th>
    <th>器件更小</th>
    <th>大于5+2</th>
    <th>稳定，精准</th>
</tr>
<tr>
    <th>红外对管</th>
    <th>发散角小于10度，但是对于要求较高的工字台和转盘定位，误差太大。</th>
    <th>安装</th>
    <th>大于4.3</th>
    <th>略差，经常会检测不到</th>
</tr>
...
<div style="text-align:left"><img src="{{site.img_path}}/2015-03-30-design-of-SOR-output-circuit.png" style="width:600px">
</div>
<br>
<div style="text-align:right"><img src="{{site.img_path}}/2015-03-30-design-of-transistor-outout-circuit .png" style="width:600px">
</div>
<br>
