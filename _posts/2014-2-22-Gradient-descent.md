...
\begin{equation} \label{4-12} \begin{align}
 ...
 & \left[ \begin{matrix}
   2{d\_x}(\frac{1}{2}-q\_{3}^{2}-q\_{4}^{2})+2{d\_y}({q\_1}{q\_4}+{q\_2}{q\_3})+2{d\_z}({q\_2}{q\_4}-{q\_1}{q\_3})-{s\_x}  \\
   2{d\_x}({q\_2}{q\_3}-{q\_1}{q\_4})+2{d\_y}(\frac{1}{2}-q\_{2}^{2}-q\_{4}^{2})+2{d\_z}({q\_1}{q\_2}+{q\_3}{q\_4})-{s\_y}  \\
   2{d\_x}({q\_1}{q\_3}+{q\_2}{q\_4})+2{d\_y}({q\_3}{q\_4}-{q\_1}{q\_2})+2{d\_z}(\frac{1}{2}-q\_{2}^{2}-q\_{3}^{2})-{s\_z}  \\
\end{matrix} \right] \\ 
